...
mensagem = tk.Label(text="Sistema de Busca de Cotação de Moedas", fg='white', bg='#000', width=50, height=10)
mensagem.grid(row=0, column=0, columnspan=2, sticky="NSEW")

mensagem2 = tk.Label(text="Selecione a moeda desejada", width=70, height=15)
